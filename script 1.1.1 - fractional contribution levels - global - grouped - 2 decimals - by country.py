...
df_fractional = pd.read_csv('2 - output/script 1.1 - fractional distribution - global/1.1 - frac dist - global.csv')


# load countries
df_world = gpd.read_file("1 - input/map/ne_110m_admin_0_countries.shp")
...
# Loop over each country in emde_countries
...
df_fractional_country.to_csv('2 - output/script 1.1.1 - fractional distribution - global - country specified/1.1 - frac dist - global - by country.csv', index=False)

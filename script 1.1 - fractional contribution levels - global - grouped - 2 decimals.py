# In[1]:
# Date: Sep 26, 2024
# Project: Identify grid level fractional contribution levels --- Global --- grouped to 2 decimal places
...
df_overall.to_csv('2 - output/script 1.1 - fractional distribution - global/1.1 - frac dist - global.csv', index=False)

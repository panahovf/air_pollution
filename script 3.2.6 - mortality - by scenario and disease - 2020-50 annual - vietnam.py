...
df_concentration_cp = pd.read_excel('2 - output/script 2.7 - air pollution concentration levels - by scenario - vietnam/1.1 - annual concentration levels - current policy.xlsx')
df_concentration_nz = pd.read_excel('2 - output/script 2.7 - air pollution concentration levels - by scenario - vietnam/1.2 - annual concentration levels - netzero 1.5C 50% adjsuted.xlsx')
...
df_pop_project = df_pop_project.loc[df_pop_project['Country Code'] == "VNM"]
...
df_annual_response_cp_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/1.1.1 - annual response function - current policy.xlsx', index = False)
df_annual_response_nz_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/1.2.1 - annual response function - NZ 1.5C 50%.xlsx', index = False)


# share attibution - annual result
df_annual_share_cp_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/2.1.1 - annual share attribution - current policy.xlsx', index = False)
df_annual_share_nz_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/2.2.1 - annual share attribution - NZ 1.5C 50%.xlsx', index = False)


# share attibution - annual change
df_annual_share_change_cp_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/3.1.1 - annual share attribution change - current policy.xlsx', index = False)
df_annual_share_change_nz_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/3.2.1 - annual share attribution change - NZ 1.5C 50%.xlsx', index = False)


# mortality rate - annual result
df_annual_mortalityrate_cp_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/4.1.1 - annual mortality rate - current policy.xlsx', index = False)
df_annual_mortalityrate_nz_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/4.2.1 - annual mortality rate - NZ 1.5C 50%.xlsx', index = False)


# mortality - annual result
df_annual_mortality_cp_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/5.1.1 - annual mortality - current policy.xlsx', index = False)
df_annual_mortality_nz_total.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/5.2.1 - annual mortality - NZ 1.5C 50%.xlsx', index = False)


# mortality - annual result - no population growth
df_annual_mortality_cp_total_nopopgrowth.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/6.1.1 - annual mortality - no pop growth - current policy.xlsx', index = False)
df_annual_mortality_nz_total_nopopgrowth.to_excel('2 - output/script 3.2.6 - mortality - by scenario and disease - 2020-50 annual - vietnam/6.2.1 - annual mortality - no pop growth - NZ 1.5C 50%.xlsx', index = False)

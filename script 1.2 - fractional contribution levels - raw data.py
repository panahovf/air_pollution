...
# 2 --- use the indexes from script 1.1 to load and filter all files

# load indexes from previous step
with open("2 - output/script 1.1/indices.json") as f:
    indices = json.load(f)
...
file_paths = [
    ...
    "1 - input/1 - fractional contribution/GBD-MAPS_Gridded_Fractional_Contributions_COAL.csv",
    "1 - input/1 - fractional contribution/GBD-MAPS_Gridded_Fractional_Contributions_ENEcoal.csv",
    "1 - input/1 - fractional contribution/GBD-MAPS_Gridded_Fractional_Contributions_INDcoal.csv",
    "1 - input/1 - fractional contribution/GBD-MAPS_Gridded_Fractional_Contributions_OTHER.csv",
    "1 - input/1 - fractional contribution/GBD-MAPS_Gridded_Fractional_Contributions_ENEother.csv",
    "1 - input/1 - fractional contribution/GBD-MAPS_Gridded_Fractional_Contributions_INDother.csv",
    "1 - input/1 - fractional contribution/GBD-MAPS_Gridded_Fractional_Contributions_RCORother.csv"
]


# Set chunk size and output folder
chunk_size = 100_000
output_folder = "2 - output/script 1.2/"

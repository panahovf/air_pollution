...
df_frac_contribution = pd.read_csv('1 - input/1 - fractional contribution/fractional contribution - germany.csv')
...
df_concentration_baseline = pd.read_csv('1 - input/2 - concentration levels/concentration levels - germany.csv')
...
df_cp_power = df_cp_power.loc[df_cp_power['Region'] == "DEU"]
df_nz_power = df_nz_power.loc[df_nz_power['Region'] == "DEU"]
...
df_concentration_cp_annual.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/1.1 - annual concentration levels - current policy.xlsx', index = False)
df_concentration_nz_annual.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/1.2 - annual concentration levels - netzero 1.5C 50% adjsuted.xlsx', index = False)
df_concentration_max_annual.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/1.3 - annual concentration levels - full shut down.xlsx', index = False)


# --------------
# annual concentration levels --- by fuel type --- CP
df_concentration_cp_coal_power.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/2.1 - annual concentration levels - current policy - coal - power.xlsx', index = False)
df_concentration_cp_oilgas_power.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/2.3 - annual concentration levels - current policy - oilgas - power.xlsx', index = False)
df_concentration_cp_total.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/2.5 - annual concentration levels - current policy - total fossil.xlsx', index = False)


# --------------
# annual concentration levels --- by fuel type --- NZ
df_concentration_nz_coal_power.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/3.1 - annual concentration levels - netzero 1.5C 50% adjsuted - coal - power.xlsx', index = False)
df_concentration_nz_oilgas_power.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/3.3 - annual concentration levels - netzero 1.5C 50% adjsuted - oilgas - power.xlsx', index = False)
df_concentration_nz_total.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/3.5 - annual concentration levels - netzero 1.5C 50% adjsuted - total fossil.xlsx', index = False)


# --------------
# annual concentration levels --- by fuel type --- MAX
df_concentration_max_coal_power.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/4.1 - annual concentration levels - full shut down - coal - power.xlsx', index = False)
df_concentration_max_oilgas_power.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/4.3 - annual concentration levels - full shut down - oilgas - power.xlsx', index = False)
df_concentration_max_total.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/4.5 - annual concentration levels - full shut down - total fossil.xlsx', index = False)


# --------------
# emissions changes by type
df_cp_power_reduction.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/5.1 - emissions vs base year - current policy -  power.xlsx', index = False)
df_nz_power_reduction.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/5.3 - emissions vs base year - netzero 1.5C 50% adjsuted -  power.xlsx', index = False)


# --------------
# population
df_population.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/6.1 - population - 2020 - unfiltered.xlsx', index = False)


# --------------
# grid level NZ
df_concentration_nz_total.to_excel('2 - output/script 2.2 - air pollution concentration levels - by scenario - germany/7.1 - concentration level - netzero 1.5C 50% adjusted - grid level.xlsx', index = False)
